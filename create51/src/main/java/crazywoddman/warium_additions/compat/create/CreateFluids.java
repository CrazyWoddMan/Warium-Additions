...
public class CreateFluids {
    public static final FluidEntry<Flowing> YELLOWCAKE_FLUID = Registrate.REGISTRATE
		.fluid(
			"yellowcake_mixture",
			ResourceLocation.fromNamespaceAndPath(WariumAdditions.MODID, "block/yellowcake_mixture_still"),
			ResourceLocation.fromNamespaceAndPath(WariumAdditions.MODID, "block/yellowcake_mixture_flow"),
	...
	public static final Map<String, Supplier<Fluid>> FLUIDS = Map.of(
        "yellowcake", () -> YELLOWCAKE_FLUID.get().getSource()
    );
