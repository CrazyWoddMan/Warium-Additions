...
public class ColoringRecipe implements Recipe<Container> {
    ...
    public RecipeSerializer<?> getSerializer() {
        return WariumAdditionsRecipes.COLORING_RECIPE_SERIALIZER.get();
    }

    @Override
    public RecipeType<?> getType() {
        return WariumAdditionsRecipes.COLORING_RECIPE_TYPE.get();
    }
    ...
    public static class ColoringRecipeType implements RecipeType<ColoringRecipe> {}

    public static class ColoringRecipeSerializer implements RecipeSerializer<ColoringRecipe> {
