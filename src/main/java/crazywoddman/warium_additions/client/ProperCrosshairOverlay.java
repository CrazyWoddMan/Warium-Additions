...
import crazywoddman.warium_additions.mixins.crusty_chunks.weapons.WeaponCrossOverlayCancel;
...
/**
 * A replacement for Warium's Weapon Cross, compatible with Resource Packs
 * @see WeaponCrossOverlayCancel
 */
@EventBusSubscriber(modid = WariumAdditions.MODID, bus = EventBusSubscriber.Bus.FORGE, value = Dist.CLIENT)
public class ProperCrosshairOverlay {
