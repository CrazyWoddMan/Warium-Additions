...
public class LatheCategory implements IRecipeCategory<LatheRecipes> {
    ...
    public void draw(LatheRecipes recipe, IRecipeSlotsView slots, GuiGraphics graphics, double mouseX, double mouseY) {
        ...
        graphics.blit(
            ResourceLocation.fromNamespaceAndPath(WariumAdditions.MODID, isDropoff() ? "textures/jei/lathe_conveyor.png" : "textures/jei/lathe_dropoff.png"),
            0, 0,
            0, 0,
            152, 160,
            152, 160
        ...
        if (mouseX >= 27 && mouseX <= 49 && mouseY >= 0 && mouseY <= 40) {
            ...
            tooltip.addAll(WariumAdditionsUtil.getWariumStack("lathe").getTooltipLines(
