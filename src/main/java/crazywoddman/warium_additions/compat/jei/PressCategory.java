...
public class PressCategory implements IRecipeCategory<PressRecipes> {
    ...
    public static final RecipeType<PressRecipes> TYPE = RecipeType.create("crusty_chunks", "press", PressRecipes.class);
    ...
    @Override
    public void draw(PressRecipes recipe, IRecipeSlotsView slots, GuiGraphics graphics, double mouseX, double mouseY) {
        ...
        if (mouseX >= 27 && mouseX <= 49 && mouseY >= 2 && mouseY <= 26) {
            ...
            tooltip.addAll(WariumAdditionsUtil.getWariumStack("press").getTooltipLines(
    ...
    @Override
    public boolean handleInput(PressRecipes recipe, double mouseX, double mouseY, InputConstants.Key input) {
